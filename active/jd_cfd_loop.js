...
[task_local]
#财富岛热气球挂后台
0 1-23/3 * * * jd_cfd_loop.js, tag=财富岛热气球挂后台, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon===============
[Script]
cron "0 1-23/3 * * *" script-path=jd_cfd_loop.js, tag=财富岛热气球挂后台
=============Surge===========
[Script]
财富岛热气球挂后台 = type=cron,cronexp="0 1-23/3 * * *",wake-system=1,timeout=3600,script-path=jd_cfd_loop.js

============小火箭=========
财富岛热气球挂后台 = type=cron,script-path=jd_cfd_loop.js, cronexpr="0 1-23/3 * * *", timeout=3600, enable=true
*/
