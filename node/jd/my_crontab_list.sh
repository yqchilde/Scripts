# 兑换500豆子
0 */3 * * * wget https://raw.sevencdn.com/yqchilde/Scripts/main/node/jd/joy_reword.js -O /scripts/joy_reword.js
3,6,9 0 8,16 * * * node /scripts/joy_reward.js >> /scripts/logs/joy_reward.log 2>&1

# 华硕-爱奇艺
1 */3 * * * wget https://raw.sevencdn.com/i-chenzhe/qx/main/jd_asus_iqiyi.js -O /scripts/jd_asus_iqiyi.js
0 0 22-28 2 * node /scripts/jd_asus_iqiyi.js >> /scripts/logs/jd_asus_iqiyi.log 2>&1

# 跳一跳
2 */3 * * * wget https://raw.sevencdn.com/i-chenzhe/qx/main/jd_jump-jump.js -O /scripts/jd_jump-jump.js
5 8,14,20 22-27 2 * node /scripts/jd_jump-jump.js >> /scripts/logs/jd_jump-jump.log 2>&1

# 百变大咖秀
3 */3 * * * wget https://raw.sevencdn.com/i-chenzhe/qx/main/jd_entertainment.js -O /scripts/jd_entertainment.js
10 10,11 * * 2-5 node /scripts/jd_entertainment.js >> /scripts/logs/jd_entertainment.log 2>&1

# 粉丝互动
4 */3 * * * wget https://raw.sevencdn.com/i-chenzhe/qx/main/jd_fanslove.js -O /scripts/jd_fanslove.js
