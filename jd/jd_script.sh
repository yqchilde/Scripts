...
# 添加定时任务
{
  ...
  printf "# 探秘无限星空\n15 8 9-13 5 * node /scripts/diy_adolf_ETIP.js >> /scripts/logs/diy_adolf_ETIP.log 2>&1\n"
  printf "# 海尔_欢乐大逃亡\n15 8 7-31 5 * node /scripts/diy_adolf_haier.js >> /scripts/logs/diy_adolf_haier.log 2>&1\n"
