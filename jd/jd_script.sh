...
# 添加定时任务
{
  ...
  printf "# 大牌联合618提前购\n0 19 * * * node /scripts/diy_zooOpencard01.js >> /scripts/logs/diy_zooOpencard01.log 2>&1\n"
  printf "# 大牌强联合好物提前购\n0 19 * * * node /scripts/diy_zooOpencard02.js >> /scripts/logs/diy_zooOpencard02.log 2>&1\n"
  printf "# 大牌强联合好物提前购\n0 19 * * * node /scripts/diy_zooOpencard03.js >> /scripts/logs/diy_zooOpencard03.log 2>&1\n"
  printf "# 大牌联合宠爱有礼\n0 19 * * * node /scripts/diy_zooOpencard04.js >> /scripts/logs/diy_zooOpencard04.log 2>&1\n"
  printf "# 大牌联合'臻'宠粉丝\n10 10 4-20 6 * node /scripts/diy_zooOpencard05.js >> /scripts/logs/diy_zooOpencard05.log 2>&1\n"
