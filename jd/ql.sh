...
sed -i -e 's/curl https:\/\/gitee.com\/yqchilde\/Scripts\/raw\/main\/jd\/ql.sh | bash/\/bin\/bash -c "$(curl -fsSL https:\/\/gitee.com\/yqchilde\/Scripts\/raw\/main\/jd\/ql.sh)"/g' /ql/config/extra.sh
